 ...
 */
var version = {
  full: '1.3.0-beta.8',    // all of these placeholder strings will be replaced by grunt's
  major: 1,    // package task
  minor: 3,
  dot: 0,
  codeName: 'accidental-haiku'
};
  ...
  this.$get = ['$timeout', '$$asyncCallback', function($timeout, $$asyncCallback) {
    ...
    return {
      ...
      addClass : function(element, className, done) {
        ...
        jqLite(element).addClass(className);
        async(done);
      },
      ...
      removeClass : function(element, className, done) {
        ...
        jqLite(element).removeClass(className);
        async(done);
      },
      ...
      setClass : function(element, add, remove, done) {
        ...
        jqLite(element).addClass(add);
        jqLite(element).removeClass(remove);
        async(done);
      },
...
function checkboxInputType(scope, element, attr, ctrl, $sniffer, $browser, $filter, $parse) {
  var trueValue = attr.ngTrueValue || parseConstantExpr($parse, scope, 'ngTrueValueExp', attr.ngTrueValueExp, true);
  var falseValue = attr.ngFalseValue || parseConstantExpr($parse, scope, 'ngFalseValueExp', attr.ngFalseValueExp, false);
